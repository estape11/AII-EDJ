...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../de1_arm_nios.sopcinfo
...
# Design Name 
# setting SOPC_NAME is de1_arm_nios
SOPC_NAME := de1_arm_nios
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8001018
SOPC_SYSID_FLAG += --sidp=0x8001018
ELF_PATCH_FLAG  += --sidp 0x8001018

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1553495300
SOPC_SYSID_FLAG += --timestamp=1553495300
ELF_PATCH_FLAG  += --timestamp 1553495300
